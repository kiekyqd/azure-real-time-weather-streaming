...
def weatherapifunction(myTimer: func.TimerRequest) -> None:
    ...
    EVENT_HUB_NAMESPACE = "weatherstreamingeventhubs.servicebus.windows.net" 
            ...
            'forecast': [
                {
                    ...
                    'condition': str(day.get('day', {}).get('condition', {}).get('text', '')),
    ...
    def fetch_weather_data():
        ...
        VAULT_URL = "https://kv-for-weather-streaming.vault.azure.net/"
